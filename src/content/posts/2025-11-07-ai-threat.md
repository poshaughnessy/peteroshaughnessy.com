...
The conversation discusses the arguments of [Roman Yampolskiy](https://en.wikipedia.org/wiki/Roman_Yampolskiy) and how they are based on sound reasoning. Essentially:
...
There's a lot of smart people working on the ["alignment problem"](https://en.wikipedia.org/wiki/AI_alignment) - to try to ensure that AI aligns with our human goals and values. But they're in a race against the systemic forces pushing for ever greater AI capabilities, faster and faster.

We're putting a huge amount of trust in a few companies to get this right. Many estimates - like one Claude AI provides in Kevin's [introspection blog post](https://medium.com/@ZombieCodeKill/claude-on-feeling-and-introspection-bc732c0a206b) - give a better chance of catastropic failure, than success.

So what should the rest of us do about this? I haven't really figured this out yet. But firstly, I'm trying to read up on potential campaigns and regulations to help AI stay safe.

I've seen campaigns like [Stop AI](https://www.stopai.info/) and [Pause AI](https://pauseai.info/) who have a [petition](https://pauseai.info/statement). I kind of wish they had called them something like "Stop _AGI_" instead as that would be a bit easier to get behind. Like Yampolskiy, I'm not necessarily against _narrow_ AI and I certainly don't want to appear as though I'm telling my colleagues and friends to stop using AI altogether.

There's also [Keep The Future Human](https://keepthefuturehuman.ai/), who have a good [Executive Summary](https://keepthefuturehuman.ai/essay/docs/executive-summary) explaining _"why and how we should close the gates to AGI and superintelligence, and what we should build instead"_.

Otherwise, I'm keeping my ear to the ground. Please let me know if you have ideas?
