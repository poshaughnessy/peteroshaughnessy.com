...
The first blog post from Kevin which really hit me for six was [this one](https://medium.com/@ZombieCodeKill/claude-on-the-piers-morgan-ai-special-e056c186c932) which discusses the arguments of [Roman Yampolskiy](https://en.wikipedia.org/wiki/Roman_Yampolskiy) - author of _AI: Unexplainable, Unpredictable, Uncontrollable_.
...
- And it could happen _fast_, due to the massive scaling up of AI infrastructure and AI 'recursive self-improvement'. Some believe AGI could now [only be a few years away](https://theagiclock.com/), with ASI shortly after.
...
And these AI companies are incentivised to race ahead with minimal effort on safety, because AGI will confer huge power and wealth. The people working on AI safety are in a race against all the systemic forces pushing for ever greater AI capabilities, ever faster.

And even if we could ensure superintelligence will be as "aligned" as possible with us humans (seemingly a tough prospect, as we're not even aligned amongst ourselves!), I for one am not comfortable with handing the keys of the world over to a human-wrought 'god'.
